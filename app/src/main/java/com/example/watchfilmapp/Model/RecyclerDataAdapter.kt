package com.example.watchfilmapp.Model
...
class RecyclerDataAdapter(val data: ArrayList<Film>, val onItemClickedCallBack: IRVOnItemClick) : RecyclerView.Adapter<RecyclerDataAdapter.ViewHolder>() {
    ...
    class ViewHolder(itemView: View): RecyclerView.ViewHolder(itemView) {
        ...
        lateinit var textViewImage: ImageView
        lateinit var linearLayout: LinearLayout
        init {
            linearLayout = itemView.findViewById<LinearLayout>(R.id.listItemLayout)
            textViewName = itemView.findViewById<TextView>(R.id.itemName)
